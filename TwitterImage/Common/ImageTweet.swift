...
extension ImageTweet {
    static let tweets = Resource(url: URL(string: "https://api.twitter.com/1.1/search/tweets.json?q=%23cooking%20filter%3Aimages&include_entities=true&count=100")!) { (json) throws -> [ImageTweet] in
